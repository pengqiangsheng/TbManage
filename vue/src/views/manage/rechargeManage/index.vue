<template>
  <div>
    <el-row class="button-wrapper">
      <el-col>
        <el-button type="primary">充值处理</el-button>
      </el-col>
    </el-row>
    <el-row>
      <el-table
      ...
      >
        ...
        <el-table-column class-name="status-col" label="操作" min-width="200" align="center">
          <template slot-scope="scope">
            <el-button v-if="!scope.row.isCheck" type="primary" @click="open(scope.row)">处理</el-button>
          </template>
        </el-table-column>
      </el-table>
      <page-comp
    ...
    <el-dialog title="处理申请" :width="'400px'" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="订单号码" :label-width="formLabelWidth">
          <el-input v-model="form.order" :disabled="true" autocomplete="off" />
        </el-form-item>
        <el-form-item label="充值平台" :label-width="formLabelWidth">
          <el-input v-model="form.platform" :disabled="true" autocomplete="off" />
        </el-form-item>
